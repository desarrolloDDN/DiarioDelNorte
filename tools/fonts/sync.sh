#!/usr/bin/env bash
#
# Copia los .woff2 (subconjunto latino) de los paquetes
# @fontsource-variable/* a theme/assets/fonts/. Ejecutar tras
# `npm --prefix theme install` cuando cambie alguna versión de fuente.
#
#   Titulares .... Lora            (variable, redonda + itálica)
...
cp "$SRC/lora/files/lora-latin-wght-normal.woff2"                     "$DST/lora.woff2"
cp "$SRC/lora/files/lora-latin-wght-italic.woff2"                     "$DST/lora-italic.woff2"
